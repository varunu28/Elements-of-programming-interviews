...
public class AssertUtils {
  ...
  public static void assertSameListPosting(PostingListNode<Integer> expected,
      PostingListNode<Integer> result) {
  ...
  public static void assertListOfListsEqual(List<List<Integer>> expected,
